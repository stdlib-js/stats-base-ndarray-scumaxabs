...
tape( 'the function has an arity of 1', function test( t ) {
	t.strictEqual( scumaxabs.length, 1, 'has expected arity' );
	t.end();
});

tape( 'the function calculates the cumulative maximum absolute value of a one-dimensional ndarray', function test( t ) {
	var expected;
	var xbuf;
	var x;
	var y;
	...
	expected = new Float32Array( [ 1.0, 2.0, 4.0, 5.0, 5.0, 5.0 ] );
